...
experiment <- list(
  ...
  simulation_start = as.POSIXct("1987-01-01 00:00:00", tz = timezone),
  simulation_end   = as.POSIXct("2009-12-31 23:00:00", tz = timezone),
  
  calibration_start = as.POSIXct("1989-01-01 00:00:00", tz = timezone),
  calibration_end   = as.POSIXct("1998-12-31 23:00:00", tz = timezone),
  
  evaluation_start = as.POSIXct("1999-01-01 00:00:00", tz = timezone),
  evaluation_end   = as.POSIXct("2009-12-31 23:00:00", tz = timezone),
