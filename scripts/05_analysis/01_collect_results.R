...
# ==============================================================================
# Collect emulator results across experiment folds and refinement steps
#
# For each held-out basin, emulator, and refinement step, this script retrieves
# the corresponding candidate set, keeps candidates successfully evaluated with
# FUSE, and selects the one ranked highest by emulator-predicted NKGE.
# ==============================================================================
...
# ==============================================================================
# Collect test results across refinement steps
# ==============================================================================
...
for (fd in folds) {
  ...
  for (step in 0:experiment$nRefinementSteps) {
